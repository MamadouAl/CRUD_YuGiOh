 ...
 */
final class Version20240321141404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carte_possedee (
        carte_id INT NOT NULL, 
        edition_id INT NOT NULL, 
        langue_id INT NOT NULL, 
        quantite INT NOT NULL, 
        INDEX IDX_6AD38973C9C7CEB6 (carte_id), 
        INDEX IDX_6AD3897374281A5E (edition_id), 
        INDEX IDX_6AD389732AADBACD (langue_id), 
        PRIMARY KEY(carte_id, edition_id, langue_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
